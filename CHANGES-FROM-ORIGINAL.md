...
## 🛠 Implementing Skill Locking (step-by-step)

How to reproduce this feature on a fresh ClawPanel (e.g. the original repo).
Every step below is **✅ implemented** in this fork — file references included.
